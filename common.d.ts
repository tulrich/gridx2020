...
type EnergySource = 'solar' | 'wind' | 'hydro' | 'nuclear' | 'ng' | 'coal' | 'battery' | 'h2';
...
interface ScenarioOutcome {
  ...
  // The amount of CO2 emissions produced by energy generation in metric
  // tonnes.
  co2: number;

  // The amount of energy consumption in MWh.
  //
